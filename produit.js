var Prodruit = function( nom, prix){
		  this.nom=nom;
		  this.prix;
		  }
...
var Produit = function (nom, prix){
		  ...
		  var Panier = function(nom, prix, totalHT, totalTTC){
  		    this.totalHT = 0.00;
  		    this.totalTTC = 0.00;
		  ...
		  var panier = new Panier();  panier.ajoute(baguette);
		  panier.ajoute(croissant);  panier.retire(baguette);
